...
class Design_3_3_Slowdown extends ActorScript
{          	
...
public var _WaterSlowdown:Float;
...
nameMap.set("Water Slowdown", "_WaterSlowdown");
_WaterSlowdown = 0.95;
...
{
                if(asBoolean(actor.getActorValue("Is Underwater?")))
{
                    actor.setXVelocity((actor.getXVelocity() * _WaterSlowdown));
}
